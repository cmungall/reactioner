...
These are generated bythe reactionER code, see Makefle for details

Note the best way to explore these is via the accompanying Jupyter Notebooks

 * [GO-Rhea-Analysis.ipynb](http://nbviewer.jupyter.org/github/cmungall/reactioner/blob/master/GO-Rhea-Analysis.ipynb) Xref analysis
 * [Chemical-Name-Usage.ipynb](http://nbviewer.jupyter.org/github/cmungall/reactioner/blob/master/Chemical-Name-Usage.ipynb) usage of chemical names
 * [GO-TextDef-Analysis.ipynb](http://nbviewer.jupyter.org/github/cmungall/reactioner/blob/master/GO-TextDef-Analysis.ipynb) parsing GO text defs
